...
const nodes = [
  ...
  { id: 'publish', position: [3.3, 23.4], label: 'PUBLISH', svg: 'rectangle_default.svg', size: [2.15, 1.25], tier: 7, shape: 'rectangle' },
...
export const homepageFlow = {
  root: 'core',
  nodes,
  terminalContinuationNodes: ['publish', 'stream'],
  sideEntryEdges: [['vault', 'graph']],
  branches: {
    core: ['vault', 'library'],
    vault: ['graph', 'stack'],
    library: ['secure'],

...
it('uses the contact core PNG set instead of mounting WebGL on mobile', async () => {
  ...
  expect(darkImage).toHaveAttribute('src', '/images/workflows/mobile/contact-core-flow.png');
  ...
  expect(lightImage).toHaveAttribute('src', '/images/workflows/mobile/contact-core-flow-light.png');
  expect(lightImage).toHaveAttribute(
    'srcset',
    '/images/workflows/mobile/contact-core-flow-light.png 1x, /images/workflows/mobile/contact-core-flow-light@2x.png 2x, /images/workflows/mobile/contact-core-flow-light@3x.png 3x',
  );
});

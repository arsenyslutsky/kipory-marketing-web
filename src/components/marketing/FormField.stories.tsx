...
const meta = {
  ...
  argTypes: {
    ...
    controlMargin: { control: { type: 'range', min: 0, max: 40, step: 1 }, table: { category: 'Spacing' } },
  ...
  render: (args) => <MarketingSection tone="alternate" paddingTop={80} paddingBottom={80}><SiteContainer {...siteContainerHomepageProps}><div style={{ maxWidth: 520 }}><FormField {...args}><FormInput id="storybook-email" type="email" placeholder="name@company.com" /></FormField></div></SiteContainer></MarketingSection>,
} satisfies Meta<typeof FormField>;

export default meta;
type Story = StoryObj<typeof meta>;
export const Foundation: Story = { args: { fieldGap: 8, controlPadding: 12, controlMargin: 0, textareaHeight: 110 } };
